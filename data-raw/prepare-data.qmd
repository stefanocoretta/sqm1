...
```{r}
download.file(
  "https://github.com/cran/languageR/raw/master/data/dativeSimplified.rda",
  here("data-raw/assessments/ft3/dativeSimplified.rda")
)

load(here("data-raw/assessments/ft3/dativeSimplified.rda"))

dativeSimplified <- dativeSimplified %>%
  mutate(
    LengthOfTheme = exp(LengthOfTheme)
  )

write_csv(dativeSimplified, here("data-raw/assessments/ft3/dativeSimplified.csv"))
```
